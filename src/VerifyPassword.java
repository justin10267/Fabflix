...
public class VerifyPassword {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(new StrongPasswordEncryptor().encryptPassword("4989"));
		System.out.println(new StrongPasswordEncryptor().checkPassword("4989", "4qKjOXNZ2OJIOkwSpYU0zdFUn+uDjX5QVQgJmBRrMi12gBh0ccPzwfhJWtWnyXw9"));
